...
let output = {
  "Tanweer-Light": {},
  "Tanweer-Light-Italic": {},
  "Tanweer-Light-Bold": {},
  "Tanweer-Light-Italic-Bold": {},
  "Tanweer-Dark": {},
  "Tanweer-Dark-Italic": {},
  "Tanweer-Dark-Bold": {},
  "Tanweer-Dark-Italic-Bold": {},
};
...
function scope2token(type, file) {
  let token = [];
  file =
    type == "light" ? file.replace("-Light", "") : file.replace("-Dark", "");
  const fontStyleKey = file.replace(/^Tanweer/, "Eva");
  for (let i in syntax) {
    let obj = {
      name: syntax[i].name,
      scope: i,
      settings: {
        ...
        fontStyle: syntax[i].fontStyle[fontStyleKey] || "",
      },
    };
    token.push(obj);
  }
